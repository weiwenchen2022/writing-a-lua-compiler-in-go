...
// lua-5.3.5/src/lbaselib.c#luaB_print()
...
// lua-5.3.5/src/lbaselib.c#luaB_assert()
...
// lua-5.3.5/src/lbaselib.c#luaB_error()
...
// lua-5.3.5/src/lbaselib.c#luaB_select()
...
// lua-5.3.5/src/lbaselib.c#luaB_ipairs()
...
// lua-5.3.5/src/lbaselib.c#luaB_pairs()
func basePairs(ls LuaState) int {
	ls.CheckAny(1)

	if LUA_TNIL == ls.GetMetafield(1, "__pairs") { /* no metamethod? */
		ls.PushGoFunction(baseNext) /* will return generator, */
		ls.PushValue(1) /* state, */
		ls.PushNil()
	} else {
		ls.PushValue(1) /* argument 'self' to metamethod */
		ls.Call(1, 3) /* get 3 values form metamethod */
	}
...
// lua-5.3.5/src/lbaselib.c#luaB_next()
func baseNext(ls LuaState) int {
	ls.CheckType(1, LUA_TTABLE)
	ls.SetTop(2) /* create 2nd argument if there isn't one */
...
// lua-5.3.5/src/lbaselib.c#luaB_load()
...
// lua-5.3.5/src/lbaselib.c#load_aux()
...
// lua-5.3.5/src/lbaselib.c#luaB_loadfile()
...
// lua-5.3.5/src/lbaselib.c#luaB_dofile()
...
// lua-5.3.5/src/lbaselib.c#luaB_getmetatable()
...
// lua-5.3.5/src/lbaselib.c#luaB_setmetatable()
func baseSetMetatable(ls LuaState) int {
	ls.CheckType(1, LUA_TTABLE)
	t := ls.Type(2)
	ls.ArgCheck(LUA_TNIL == t || LUA_TTABLE == t, 2,
...
// lua-5.3.5/src/lbaselib.c#luaB_rawequal()
...
// lua-5.3.5/src/lbaselib.c#luaB_rawlen()
func baseRawLen(ls LuaState) int {
	t := ls.Type(1)
	ls.ArgCheck(LUA_TTABLE == t || LUA_TSTRING == t, 1,
...
// lua-5.3.5/src/lbaselib.c#luaB_rawget()
...
// lua-5.3.5/src/lbaselib.c#luaB_rawset()
...
// lua-5.3.5/src/lbaselib.c#luaB_type()
...
// lua-5.3.5/src/lbaselib.c#luaB_tostring()
...
// lua-5.3.5/src/lbaselib.c#luaB_tonumber()
func baseToNumber(ls LuaState) int {
	if ls.IsNoneOrNil(2) { /* standard conversion? */
		ls.CheckAny(1)
		
		if LUA_TNUMBER == ls.Type(1) { /* already a number? */
...
// lua-5.3.5/src/lbaselib.c#luaopen_base()
