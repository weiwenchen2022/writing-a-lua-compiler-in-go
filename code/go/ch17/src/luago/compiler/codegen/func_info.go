...
func (self *funcInfo) emitABC(opcode, a, b, c int) int {
...
func (self *funcInfo) emitABx(opcode, a, bx int) int {
	i := bx << 14 | a << 6 | opcode
	self.insts = append(self.insts, uint32(i))
...
func (self *funcInfo) emitAsBx(opcode, a, b int) int {
	return self.emitABx(opcode, a, b + MAXARG_sBx)
}

func (self *funcInfo) emitAx(opcode, ax int) int {
	i := ax << 6 | opcode
	self.insts = append(self.insts, uint32(i))
...
func (self *funcInfo) emitJmp(a, sBx int) int {
	return self.emitAsBx(OP_JMP, a, sBx)
}
...
func (self *funcInfo) emitForPrep(a, sBx int) int {
	return self.emitAsBx(OP_FORPREP, a, sBx)
}

// r(a) += r(a + 2); if r(a) <?= r(a+1) then { pc += sBx; r(a + 3) = r(a) }
func (self *funcInfo) emitForLoop(a, sBx int) int {
	return self.emitAsBx(OP_FORLOOP, a, sBx)
}

// r(a+3), ..., r(a+2+c) := r(a)(r(a+1), r(a+2))
func (self *funcInfo) emitTForCall(a, c int) int {
	return self.emitABC(OP_TFORCALL, a, 0, c)
}

// if r(a+1) ~= nil then { r(a) = r(a+1); pc += sBx }
func (self *funcInfo) emitTForLoop(a, sBx int) int {
	return self.emitAsBx(OP_TFORLOOP, a, sBx)
}
